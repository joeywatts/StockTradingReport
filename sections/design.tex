...
\begin{figure}[h]
  ...
  \begin{center}
    \includegraphics[width=3in]{microblogPostSchema}
  \end{center}
...
\end{figure}
% Figure - stockTwitsSchema
\begin{figure}[h]
  \label{stockTwitsSchema}
  \begin{center}
    \includegraphics[width=3in]{stockTwitsSchema}
  \end{center}
...
\begin{figure}[h]
  ...
  \begin{center}
    \includegraphics[width=3in]{portfolioStruct}
  \end{center}
...
% Figure - graph-like diagram showing the flow of data when running a trading simulation
...
% Figure - pricingDataFlow
\begin{figure}[h]
  \label{pricingDataFlow}
  \begin{center}
    \includegraphics[width=3in]{pricingDataFlow}
  \end{center}
...
% Figure - opinionAggregationFlow
\begin{figure}[h]
  \label{opinionAggregationFlow}
  \begin{center}
    \includegraphics[width=3in]{opinionAggregationFlow}
  \end{center}
...
% Figure - tradingSimulationFlow
\begin{figure}[h]
  \label{tradingSimulationFlow}
  \begin{center}
    \includegraphics[width=3in]{tradingSimulationFlow}
  \end{center}
